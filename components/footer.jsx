...
function MapleLeafIcon({ className }) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
            <path d="M12 1.5l1.633 4.079 1.858-1.072-.93 2.787 3.255-.465-1.858 2.322 2.787.93-2.787 1.395 2.322 1.858-3.255-.465.93 2.787-1.858-1.072L12 18.5l-1.633-3.916-1.858 1.072.93-2.787-3.255.465 2.322-1.858-2.787-.93 2.787-1.395-2.322-1.858 3.255.465-.93-2.787 1.858 1.072L12 1.5zM10.5 18.5L10 22.5h4l-.5-4" />
        </svg>
    );
}
